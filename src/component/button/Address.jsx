...
export default class Address extends React.Component {
    ...
    save() {
        if (typeof this.state.info["id"] !== "undefined") {
            let params = _.cloneDeep(this.state.info);
    ...
    fetchGeolocation() {
        let url = "https://nominatim.openstreetmap.org/search?format=json&q=" + this.state.fullAddress
        ...
        getForeignRequest.call(this, url, data => {
            if (Array.isArray(data)) {
                this.setState({
                    geolocations: 
                        data.map(d => { return {latitude: d.lat, longitude: d.lon}})
                });
            } else {
                this.setState({
                    geolocations: [],
    ...
    validateGeolocation() {
        ...
        this.setState({ info: info, selectedGeolocation: null });
                                            ...
                                            this.state.geolocations.map(g => {
                                                return (
                                                    <Geolocation
                                                        ...
                                                        onClick={() => this.setState({ selectedGeolocation: {
                                                            latitude: g.latitude,
