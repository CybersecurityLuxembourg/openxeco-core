...
export default class EntityAddress extends React.Component {
	...
	getAddresses() {
		...
		getRequest.call(this, "private/get_my_entity_addresses/" + this.props.entityId, (data) => {
			this.setState({
			...
			<div id="EntityAddress" className="max-sized-page fade-in">
				...
				<div className={"row row-spaced"}>
					<div className="col-md-12">
						...
						{this.state.addresses.map((a, y) => <div className="col-md-12" key={a.entity_id}>
							<h3>Address {y + 1}</h3>
							<Address
								info={a}
				...
				<div className="col-md-12">
					...
					<div className={"right-buttons"}>
						<button
							...
							disabled={ !EntityAddress.isFieldCompleted(this.state.addressToAdd.address_1)
								|| !EntityAddress.isFieldCompleted(this.state.addressToAdd.city)
								|| !EntityAddress.isFieldCompleted(this.state.addressToAdd.country)}
						>
