...
export default class TaxonomyNote extends React.Component {
	constructor(props) {
		super(props);
	...
	getNotes(page) {
		const params = {
			taxonomy_category: this.props.id,
			page: page || 1,
		};
	...
	render() {
		if (this.props.node) {
			return <Message
				text={"Not applicable on remote taxonomy"}
				height={300}
			/>;
		}

		return (
			<div id={"TaxonomyNote"} className={"row"}>
