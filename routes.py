...
from resource.cron.update_database_compliance import UpdateDatabaseCompliance
from resource.cron.update_elitecyber_job_offers import UpdateEliteCyberJobOffers
from resource.cron.update_moovijob_job_offers import UpdateMoovijobJobOffers
from resource.jobadder.get_jobadder_status import GetJobAdderStatus
from resource.jobadder.refresh_jobadder_token import RefreshJobAdderToken
...
def set_routes(api, db, mail):  # pylint: disable=too-many-statements
    ...
    api.add_resource(UpdateDatabaseCompliance, '/cron/update_database_compliance', resource_class_kwargs={"db": db})
    api.add_resource(UpdateEliteCyberJobOffers, '/cron/update_elite_cyber_job_offers', resource_class_kwargs={"db": db})
    api.add_resource(UpdateMoovijobJobOffers, '/cron/update_moovijob_job_offers', resource_class_kwargs={"db": db})

    api.add_resource(GetJobAdderStatus, '/job_adder/get_job_adder_status', resource_class_kwargs={"db": db})
    api.add_resource(RefreshJobAdderToken, '/job_adder/refresh_job_adder_token', resource_class_kwargs={"db": db})
