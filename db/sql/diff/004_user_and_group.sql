...
ALTER TABLE `User` ADD COLUMN first_name VARCHAR(110) DEFAULT NULL AFTER password;
ALTER TABLE `User` ADD COLUMN last_name VARCHAR(110) DEFAULT NULL AFTER password;
