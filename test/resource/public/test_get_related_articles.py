...
class TestGetRelatedArticles(BaseCase):
    ...
    def test_ok_with_media(self):
        ...
        self.db.insert({"article": 1, "company": 1}, self.db.tables["ArticleCompanyTag"])
        self.db.insert({"article": 3, "company": 1}, self.db.tables["ArticleCompanyTag"])
        self.db.insert({"article": 4, "company": 1}, self.db.tables["ArticleCompanyTag"])

        # Request

        response = self.application.get('/public/get_related_articles/TITLE1?media=SECURITYMADEIN.LU')
