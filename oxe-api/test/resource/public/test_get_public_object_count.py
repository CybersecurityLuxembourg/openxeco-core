...
class TestGetPublicObjectCount(BaseCase):
    ...
    def test_ok_empty_and_disabled_article_types(self, token):
        response = self.application.get('/public/get_public_object_count?include_article_types=false',
                                        headers=self.get_standard_header(token))
    ...
    def test_ok_empty_and_disabled_articles(self, token):
        response = self.application.get('/public/get_public_object_count?include_articles=false',
                                        headers=self.get_standard_header(token))
    ...
    def test_ok_empty_and_disabled_entity(self, token):
        response = self.application.get('/public/get_public_object_count?include_entities=false',
                                        headers=self.get_standard_header(token))
