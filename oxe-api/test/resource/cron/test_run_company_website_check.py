...
class TestRunEntityWebsiteCheck(BaseCase):
    ...
    def test_ok(self, mock_head, token):
        ...
        self.assertEqual(mock_head.call_args_list[0], call("http://fake-website.com", allow_redirects=True))
        self.assertEqual(mock_head.call_args_list[1], call("https://fake-website.com", allow_redirects=True))
