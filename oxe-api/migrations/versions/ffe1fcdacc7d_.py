...
def upgrade():
    ...
    op.alter_column('ArticleEntityTag', 'company', new_column_name='entity_id', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('ArticleEntityTag', 'article', new_column_name='article_id', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('ArticleTaxonomyTag', 'taxonomy_value', new_column_name='taxonomy_value_id', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('ArticleTaxonomyTag', 'article', new_column_name='article_id', existing_type=mysql.INTEGER(), existing_nullable=False)
    ...
    op.alter_column('EntityRelationship', 'company_1', new_column_name='entity_id_1', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('EntityRelationship', 'company_2', new_column_name='entity_id_2', existing_type=mysql.INTEGER(), existing_nullable=False)
...
def downgrade():
    ...
    op.alter_column('ArticleEntityTag', 'entity_id', new_column_name='company', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('ArticleEntityTag', 'article_id', new_column_name='article', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('ArticleTaxonomyTag', 'taxonomy_value_id', new_column_name='taxonomy_value', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('ArticleTaxonomyTag', 'article_id', new_column_name='article', existing_type=mysql.INTEGER(), existing_nullable=False)
    ...
    op.alter_column('EntityRelationship', 'entity_id_1', new_column_name='company_1', existing_type=mysql.INTEGER(), existing_nullable=False)
    op.alter_column('EntityRelationship', 'entity_id_2', new_column_name='company_2', existing_type=mysql.INTEGER(), existing_nullable=False)
