...
def upgrade():
    ...
    op.alter_column('TaxonomyCategory', 'active_on_companies', new_column_name='active_on_entities', existing_type=mysql.BOOLEAN())
...
def downgrade():
    ...
    op.alter_column('TaxonomyCategory', 'active_on_entities', new_column_name='active_on_companies', existing_type=mysql.BOOLEAN())
