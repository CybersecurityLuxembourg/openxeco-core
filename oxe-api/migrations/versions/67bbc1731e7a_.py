...
def upgrade():
    op.alter_column('ArticleBox', 'type',
                    type_=mysql.ENUM('PARAGRAPH', 'TITLE1', 'TITLE2', 'TITLE3', 'IMAGE', 'FRAME', 'MERMAID'),
                    server_default=sa.text("'PARAGRAPH'"), nullable=False)
    ...
    op.alter_column('UserRequest', 'type',
                    type_=mysql.ENUM('ENTITY ADD', 'ENTITY CHANGE', 'ENTITY ACCESS CLAIM',
                                     'ENTITY ADDRESS CHANGE', 'ENTITY ADDRESS ADD',
                                     'ENTITY ADDRESS DELETION', 'ENTITY TAXONOMY CHANGE',
                                     'ENTITY LOGO CHANGE', 'CONTACT FORM'), nullable=True)


def downgrade():
    op.alter_column('ArticleBox', 'type',
                    type_=mysql.ENUM('PARAGRAPH', 'TITLE1', 'TITLE2', 'TITLE3', 'IMAGE', 'FRAME'),
                    server_default=sa.text("'PARAGRAPH'"), nullable=False)
    ...
    op.alter_column('UserRequest', 'type',
                    type_=mysql.ENUM('ENTITY ADD', 'ENTITY CHANGE', 'ENTITY ACCESS CLAIM',
                                     'ENTITY ADDRESS CHANGE', 'ENTITY ADDRESS ADD',
                                     'ENTITY ADDRESS DELETION', 'ENTITY TAXONOMY CHANGE',
                                     'ENTITY LOGO CHANGE'), nullable=True)